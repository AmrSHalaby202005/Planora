...
export default function ResourcePagination({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 text-xs text-slate-500 font-medium">
      <div>
        Showing {totalItems > 0 ? indexOfFirstItem + 1 : 0} to{" "}
        {Math.min(indexOfLastItem, totalItems)} of {totalItems} resources
      </div>
